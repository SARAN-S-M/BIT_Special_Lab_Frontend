...
function SpecialSlot() {
    ...
    return (
        <div className="h-screen bg-white dark:bg-gray-900 min-w-60 relative">
            ...
            <nav>
                <NavigationBar active="Special_Slot_Booking" />
            </nav>
            ...
            <div className='p-4 md:p-10 flex flex-col items-center'>
                <div className='w-full bg-gray-100 border border-gray-500 dark:border-none dark:bg-gray-800 p-4 md:p-8 rounded-lg shadow-lg'>
                    ...
                    <div className='mb-4 md:mb-6 flex flex-col md:flex-row items-start md:items-center'>
                        <label className='text-base md:text-lg text-black dark:text-gray-300 w-full md:w-1/5 mb-2 md:mb-0'>Another Proof:</label>
                        <div className="w-full md:w-4/5 relative">
                            <input type="file" id="fileInput" className="absolute inset-0 w-full h-full opacity-0 cursor-pointer" onChange={handleFileChange} />
                            <label htmlFor="fileInput" className="w-full h-10 bg-gray-200 dark:bg-gray-700 rounded-lg text-black dark:text-gray-300 flex items-center justify-center cursor-pointer">
